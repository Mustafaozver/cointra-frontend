...
const pageFilters = { category: 0, businessType: 'rent', propertyTypes: 'APT', locations: 'dubai-palm-jumeirah' };
...
export default (props) => {
  ...
  const paginationLink = '/en/rent/apartments-for-rent-in-palm-jumeirah?page=';
  ...
  return (
    <>
      <Head>
        <title>Apartments Flats for Rent in Palm Jumeirah| zeekeez.com</title>
        <meta name="description" content="Apartments to Rent in Palm Jumeirah Dubai UAE. Rent Residential Properties in UAE : Flats, Duplexes, Lofts, Penthouses, Studios, 1 Bedroom, Beach view…"/>
        {PrevLinksRenderer()}
        {NextLinksRenderer()}
      </Head>
      <FiltersProvider overrideFilters={filters}>
        <PropertiesListPage
          ...
          mainTitle={'Apartments for rent in Palm Jumeirah Dubai UAE'}
          data={data}
        />
      </FiltersProvider>
    </>
