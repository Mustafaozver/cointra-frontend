...
export default (props) => {
  ...
  return (
    <>
      <Head>
        <title>Villas for rent in UAE | Zeekeez</title>
        <meta name="description" content="Top exclusive villas to rent in UAE are by Zeekeez: luxury villas, affordable houses, townhouses, private pool, private beach, sea view… Find your next home!"/>
