...
const pageFilters = { category: 0, businessType: 'rent', propertyTypes: 'APT', locations: 'dubai', bedrooms: '1' };
...
export default (props) => {
  ...
  return (
    <>
      <Head>
        <title>1 Bedroom Apartment for Rent in Dubai | zeekeez.com</title>
        <meta name="description" content="1 Bedrooms Apartments to Rent in Dubai UAE. Rent Residential Properties in UAE : Flats, Duplexes, Lofts, Penthouses, Studios, 1 Bedroom, Full Floors…"/>
      </Head>
      <FiltersProvider overrideFilters={filters}>
        <PropertiesListPage
          initialFilters={initialFilters}
          mainTitle={'1-Bedroom Apartments for rent in Dubai UAE'}
          data={data}
        />
      </FiltersProvider>
    </>
