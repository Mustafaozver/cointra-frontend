...
export default (props) => {
  ...
  const paginationLink = '/en/rent/villas-for-rent-in-palm-jumeirah?page=';
  ...
  return (
    <>
      <Head>
        <title>Villas for Rent in Palm Jumeirah| zeekeez.com</title>
        <meta name="description" content="Villas to Rent in Palm Jumeirah Dubai UAE. Rent Residential Properties in UAE : Villas, Houses, Homes, Townhouses, Beach views, Private pool…"/>
        {PrevLinksRenderer()}
        {NextLinksRenderer()}
      </Head>
      <FiltersProvider overrideFilters={filters}>
        <PropertiesListPage
          ...
          mainTitle={'Villas for rent in Palm Jumeirah Dubai UAE'}
          data={data}
        />
      </FiltersProvider>
    </>
