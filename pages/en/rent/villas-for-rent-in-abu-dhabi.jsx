...
const pageFilters = { category: 0, businessType: 'rent', propertyTypes: 'VIL', locations: 'abu-dhabi' };
...
export default (props) => {
  ...
  const paginationLink = '/en/rent/villas-for-rent-in-abu-dhabi?page=';
  ...
  return (
    <>
      <Head>
        <title>Villas for Rent in Abu Dhabi | zeekeez.com</title>
        <meta name="description" content="Villas to Rent in Abu Dhabi UAE. Rent Residential Properties in UAE :Villas, Houses, Homes, Townhouses, Beach views, Private pool…"/>
        {PrevLinksRenderer()}
        {NextLinksRenderer()}
      </Head>
      <FiltersProvider overrideFilters={filters}>
        <PropertiesListPage
          ...
          mainTitle={'Villas for rent in Abu Dhabi UAE'}
          data={data}
        />
      </FiltersProvider>
    </>
