...
const pageFilters = { category: 0, businessType: 'rent', propertyTypes: 'APT', locations: 'dubai-business-bay' };
...
export default (props) => {
  ...
  const paginationLink = '/en/rent/apartments-for-rent-in-business-bay?page=';
  ...
  return (
    <>
      <Head>
        <title>Apartments Flats for Rent in Business Bay | zeekeez.com</title>
        <meta name="description" content="Apartments to Rent in Business Bay Dubai UAE. Rent Residential Properties in UAE : Flats, Duplexes, Lofts, Penthouses, Studios, 1 Bedroom, Full Floors…"/>
        {PrevLinksRenderer()}
        {NextLinksRenderer()}
      </Head>
      <FiltersProvider overrideFilters={filters}>
        <PropertiesListPage
          ...
          mainTitle={'Apartments for rent in Business Bay Dubai UAE'}
          data={data}
        />
      </FiltersProvider>
    </>
