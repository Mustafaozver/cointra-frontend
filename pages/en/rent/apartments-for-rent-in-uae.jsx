...
const pageFilters = { category: 0, businessType: 'rent', propertyTypes: 'APT' };
...
export default (props) => {
  ...
  const paginationLink = '/en/rent/apartments-for-rent-in-uae?page=';
  ...
  return (
    <>
      <Head>
        <title>Apartments Flats for Rent in UAE | zeekeez.com</title>
        <meta name="description" content="Apartments to Rent in UAE. Rent Residential Properties in UAE : Flats, Duplexes, Lofts, Penthouses, Studios, 1 Bedroom, Full Floors…"/>
        {PrevLinksRenderer()}
        {NextLinksRenderer()}
      </Head>
      <FiltersProvider overrideFilters={filters}>
        <PropertiesListPage
          ...
          mainTitle={'Apartments for rent in UAE'}
          data={data}
        />
      </FiltersProvider>
    </>
