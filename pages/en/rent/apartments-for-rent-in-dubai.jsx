...
export default (props) => {
  ...
  return (
    <>
      <Head>
        <title>Dubai: Apartments for rent | Zeekeez</title>
        <meta name="description" content="Top apartments to rent in Dubai UAE! Exclusive deals on short term and long term rentals: multiple payments, low deposit, low agency fees... Yallah!"/>
