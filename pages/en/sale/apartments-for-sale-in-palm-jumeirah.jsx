...
const pageFilters = { category: 0, businessType: 'sale', propertyTypes: 'APT', locations: 'dubai-palm-jumeirah' };
...
export default (props) => {
  ...
  const paginationLink = '/en/sale/apartments-for-sale-in-palm-jumeirah?page=';
  ...
  return (
    <>
      <Head>
        <title>Apartments Flats for Sale in Palm Jumeirah| zeekeez.com</title>
        <meta name="description" content="Apartments for Sale in Palm Jumeirah Dubai UAE. Buy Sell Residential Properties in UAE : Flats, Duplexes, Lofts, Penthouses, Studios, 1 Bedroom, Full Floors…"/>
        {PrevLinksRenderer()}
        {NextLinksRenderer()}
      </Head>
      <FiltersProvider overrideFilters={filters}>
        <PropertiesListPage
          ...
          mainTitle={'Apartments for sale in Palm Jumeirah Dubai UAE'}
          data={data}
        />
      </FiltersProvider>
    </>
