...
export default (props) => {
  ...
  const paginationLink = '/en/sale/property-for-sale-in-uae?page=';
  ...
  return (
    <>
      <Head>
        <title>Property for Sale in UAE | zeekeez.com</title>
        <meta name="description" content="Property for Sale in UAE. Buy Sell Residential Properties in UAE : Apartments, Flats, Villas, Duplexes, Lofts, Penthouses, Studios, 1 Bedroom, Full Floors…"/>
        {PrevLinksRenderer()}
        {NextLinksRenderer()}
      </Head>
      <FiltersProvider overrideFilters={filters}>
        <PropertiesListPage
          ...
          mainTitle={'Property for sale in UAE'}
          data={data}
        />
      </FiltersProvider>
    </>
