...
export default (props) => {
  ...
  const paginationLink = '/en/sale/houses-for-sale-in-palm-jumeirah?page=';
  ...
  return (
    <>
      <Head>
        <title>Houses for Sale in Palm Jumeirah| zeekeez.com</title>
        <meta name="description" content="Houses for Sale in Palm Jumeirah Dubai UAE. Buy Sell Residential Properties in UAE : Villas, Houses, Homes, Townhouses, Beach views…"/>
        {PrevLinksRenderer()}
        {NextLinksRenderer()}
      </Head>
      <FiltersProvider overrideFilters={filters}>
        <PropertiesListPage
          ...
          mainTitle={'Houses for sale in Palm Jumeirah Dubai UAE'}
          data={data}
        />
      </FiltersProvider>
    </>
