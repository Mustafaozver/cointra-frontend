...
const pageFilters = { category: 0, businessType: 'sale', propertyTypes: 'APT', locations: 'abu-dhabi' };
...
export default (props) => {
  ...
  const paginationLink = '/en/sale/apartments-for-sale-in-abu-dhabi?page=';
  ...
  return (
    <>
      <Head>
        <title>Apartments Flats for Sale in Abu Dhabi | zeekeez.com</title>
        <meta name="description" content="Apartments for Sale in Abu Dhabi UAE. Buy Sell Residential Properties in UAE : Flats, Duplexes, Lofts, Penthouses, Studios, 1 Bedroom, Full Floors…"/>
        {PrevLinksRenderer()}
        {NextLinksRenderer()}
      </Head>
      <FiltersProvider overrideFilters={filters}>
        <PropertiesListPage
          ...
          mainTitle={'Apartments for sale in Abu Dhabi UAE'}
          data={data}
        />
      </FiltersProvider>
    </>
