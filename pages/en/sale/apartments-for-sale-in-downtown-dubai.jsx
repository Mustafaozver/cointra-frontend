...
const pageFilters = { category: 0, businessType: 'sale', propertyTypes: 'APT', locations: 'dubai-downtown-dubai' };
...
export default (props) => {
  ...
  const paginationLink = '/en/sale/apartments-for-sale-in-downtown-dubai?page=';
  ...
  return (
    <>
      <Head>
        <title>Apartments Flats for Sale in Downtown Dubai | zeekeez.com</title>
        <meta name="description" content="Apartments for Sale in Downtown Dubai UAE. Buy Sell Residential Properties in UAE : Flats, Duplexes, Lofts, Penthouses, Studios, 1 Bedroom, Full Floors…"/>
        {PrevLinksRenderer()}
        {NextLinksRenderer()}
      </Head>
      <FiltersProvider overrideFilters={filters}>
        <PropertiesListPage
          ...
          mainTitle={'Apartments for sale in Downtown Dubai UAE'}
          data={data}
        />
      </FiltersProvider>
    </>
