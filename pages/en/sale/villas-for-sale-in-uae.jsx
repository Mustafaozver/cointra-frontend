...
export default (props) => {
  ...
  const paginationLink = '/en/sale/villas-for-sale-in-uae?page=';
  ...
  return (
    <>
      <Head>
        <title>Villas for Sale in UAE | zeekeez.com</title>
        <meta name="description" content="Villas for Sale in UAE. Buy Sell Residential Properties in UAE : Villas, Houses, Homes, Townhouses, Beach views, Private pool..."/>
        {PrevLinksRenderer()}
        {NextLinksRenderer()}
      </Head>
      <FiltersProvider overrideFilters={filters}>
        <PropertiesListPage
          ...
          mainTitle={'Villas for sale in UAE'}
          data={data}
        />
      </FiltersProvider>
    </>
